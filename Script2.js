...
var randomx1 = Math.floor(Math.random()*201)+100;
var randomx2 = Math.floor(Math.random()*401)+300;
var randomx3 = Math.floor(Math.random()*601)+500;
var randomx4 = Math.floor(Math.random()*801)+700;

/* Runs Code when Spacebar is pressed */
document.body.onkeyup = function(press) {
    if(press.code == "Space") {
        drawLine(randomx1,randomx2,randomx3,randomx4);
      step();
    }
  }
...
/*
this one is for drawing a square
